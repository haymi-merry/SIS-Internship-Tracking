...
var TextareaAutosize = React38.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const textareaRef = React38.useRef(null);
  const handleRef = useForkRef(forwardedRef, textareaRef);
  const heightRef = React38.useRef(null);
  const hiddenTextareaRef = React38.useRef(null);
  ...
  const frameRef = React38.useRef(-1);
  useEnhancedEffect_default(() => {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-K57EQ5PF.js.map
